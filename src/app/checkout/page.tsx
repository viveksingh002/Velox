      ...
      <>
        <style>{`
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .co-conf-title { font-size: 26px; font-weight: 800; color: #111; letter-spacing: -0.8px; margin-bottom: 0.4rem; text-align: center; }
          ...
          .co-conf-row span:last-child { color: #111; font-weight: 600; }
          .co-home-btn {
        ...
        <div className="co-confirmed">
          ...
          <div className="co-conf-timer">
            ...
            Driver responding in {Math.floor(countdown / 60)}:{String(countdown % 60).padStart(2, '0')}
          </div>
    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .co-card-title { font-size: 28px; font-weight: 800; color: #111; letter-spacing: -1px; margin-bottom: 1.25rem; }

        /* Vehicle badge */
        .co-veh-badge {
          width: 48px; height: 48px; border-radius: 14px;
          background: #f0f0f0; display: flex; align-items: center; justify-content: center;
          color: #333; float: right; margin-top: -8px;
        }
        ...
        .co-route-icon { color: #bbb; cursor: pointer; flex-shrink: 0; margin-left: auto; }
      ...
      <div className="co-page">
        ...
        <div className="co-grid">
          ...
          <div className="co-card">
            ...
            <div className="co-card-title" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              <span>{vehicleName.split(' ')[0]}</span>
              <div className="co-veh-badge" style={{ float: 'none' }}>
            ...
            <div className="co-route">
              <div className="co-route-row">
                <div>
                  <div className="co-route-label">PICKUP</div>
                  <div className="co-route-dot-fill" style={{ display: 'inline-block', marginRight: 6 }} />
                  <span className="co-route-text">{pickup}</span>
                </div>
              </div>
              <div className="co-route-connector" style={{ marginLeft: 0 }} />
              <div className="co-route-row">
                <div>
                  <div className="co-route-label">DROP</div>
                  <div className="co-route-dot-empty" style={{ display: 'inline-block', marginRight: 6 }} />
                  <span className="co-route-text">{drop}</span>
                </div>
              </div>
            </div>
          ...
          <div className="co-card">
            ...
            <div className="co-features">
              {[
                ...
                {
                  icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s-8-4.5-8-11.8A8 8 0 0112 2a8 8 0 018 8.2c0 7.3-8 11.8-8 11.8z"/><circle cx="12" cy="10" r="3"/></svg>,
            ...
            <button className="co-req-btn" onClick={handleRequest} disabled={loading}>
              {loading ? (
                <><div className="co-spinner" /> Requesting...</>
              ) : (
                <>Request Ride →</>
              )}
            </button>
