...
export default function Fleet() {
  ...
  const goToBook = (vehicle: string) => (e: React.MouseEvent) => {
    e.stopPropagation()
    router.push(`/book?vehicle=${vehicle}`)
  }
    ...
    <>
      <style>{`
        ...
        .fleet-icon-wrap {
          ...
          border-radius: 18px; margin-bottom: 1.5rem; position: relative;
        ...
        .fleet-cta {
          ...
          font-weight: 600; border: none; padding: 10px 20px; border-radius: 980px;
          position: relative; z-index: 10;
          transition: gap 0.2s, opacity 0.2s;
        }
        .fleet-cta:hover { gap: 10px; opacity: 0.85; }
        .fleet-bg-svg {
        ...
        <div className="fleet-inner">
          ...
          <div className="fleet-grid">
            ...
            <div className="fleet-card fleet-card--big">
              ...
              <button
                className="fleet-cta"
                style={{ color: '#5ac8fa', background: 'rgba(90,200,250,0.1)' }}
                onClick={goToBook('bike')}
              >
                Book now
            ...
            <div className="fleet-card">
              ...
              <button
                className="fleet-cta"
                style={{ color: '#0071e3', background: 'rgba(0,113,227,0.1)' }}
                onClick={goToBook('car')}
              >
                Book now
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
              </button>
